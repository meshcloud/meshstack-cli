...
func (apiKey *ApiKey) CachedToken(_ context.Context, _ getWorkspaceFunc) (token jwt.JWT, found bool) {
	if apiKey.Cache == nil {
		return
	}
...
func (apiKey *ApiKey) RefreshCachedToken(ctx context.Context, client http.Client, _ getWorkspaceFunc) error {
