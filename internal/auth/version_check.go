...
// warnIfNewerReleasePresent lives here rather than in internal/version, which the depguard rule
// in .golangci.yml keeps closed to everything but the standard library.
