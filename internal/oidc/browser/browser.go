...
// Login supplies the two things the authorization code flow needs and internal/oidc cannot have:
// a loopback address it can receive the redirect on, and a person in front of a browser. The
